package br.com.ms.produto.adapters.handler;
...
public class CustomExceptionHandler {
    ...
    public final ResponseEntity<ExceptionResponse> produtoException(ProdutoException ex, HttpServletRequest request) {
    ...
    public final ResponseEntity<ExceptionResponse> noSuchElementException(NoSuchElementException ex, HttpServletRequest request) {
