...
public class BuscaClientePorEmailTest {
    ...
    public class BuscandoCliente {
        ...
        public void deveBuscarClienteCorretamente() {
            ...
            when(clienteGateway.buscaClientePorEmail("email", PageRequest.of(0, 10)))
                    .thenReturn(clientes);
            Page<ClienteEntity> clientesRetrieved = buscaClientePorEmail.execute("email", PageRequest.of(0, 10));
