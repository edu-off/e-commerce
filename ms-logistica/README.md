# Microsserviço de gestão de logística - Tech Challenge Pós Tech FIAP

Tech Challenge Pós Tech FIAP - Microsserviço de gestão de logística
...
### Collection com payloads de teste: [clique aqui.](https://github.com/edu-off/e-commerce/blob/main/ms-logistica/collection/logistica_collection.json)
